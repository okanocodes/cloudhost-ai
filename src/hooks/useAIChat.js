...
import { getInferenceClient, SYSTEM_PROMPT, parseAssistantResponse } from "../lib/aiChatService";
...
export function useAIChat(initialMessages = []) {
    ...
    const streamReply = useCallback(async (history) => {
        ...
        try {
            ...
            console.log("History sent to HF:", history);
            ...
            setMessages((prev) => {
                ...
                console.log("Parsed response in hook:", parsed);
                next[next.length - 1] = {
                    role: "assistant",
